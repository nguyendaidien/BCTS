...
--
-- ID2TRW4_JOB_HEADER  (Index) 
--
CREATE INDEX ID2TRW4_JOB_HEADER ON BCTS_JOB_HEADER
(USER_ID, CR_UEI_NO, CREATE_DATE);

--
-- ID3TRW4_JOB_HEADER  (Index) 
--
CREATE INDEX ID3TRW4_JOB_HEADER ON BCTS_JOB_HEADER
(CR_UEI_NO, JOB_DATE, USER_ID);

--
-- ID4TRW4_JOB_HEADER  (Index) 
--
CREATE INDEX ID4TRW4_JOB_HEADER ON BCTS_JOB_HEADER
(CR_UEI_NO, CREATE_DATE, USER_ID);

--
-- ID5TRW4_JOB_HEADER  (Index) 
--
CREATE INDEX ID5TRW4_JOB_HEADER ON BCTS_JOB_HEADER
(CR_UEI_NO, PERMIT_NO);

--
-- IDTRW4_JOB_HEADER  (Index) 
--
CREATE INDEX IDTRW4_JOB_HEADER ON BCTS_JOB_HEADER
(CR_UEI_NO, JOB_NO);
...
(
	CASE_ID 			VARCHAR2(17 BYTE) NOT NULL,
...
(
	COMMENT_ID 		VARCHAR2(17 BYTE) NOT NULL,
	CASE_ID 		VARCHAR2(17 BYTE) NOT NULL,
	USER_ID			VARCHAR2(17 BYTE) NOT NULL,
	UPDATE_TIME		DATE,
...
--INSERT 
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (1,'sam','$2a$10$4eqIF5s/ewJwHK1p8lqlFOEm2QIA0S8g6./Lok.pQxqcxaBZYChRm','Ajay','Samanta','ajaykumar99009@gmail.com',1,1,1,1,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (9,'tstsa05','$2a$10$tg/Un0zvFOOgUY3ykhapy.gEzlTp8JW3wfy2XPNWTOR9b8asgo.Wm','tstsa05','OK','tstsa05@gmail.com',1,1,1,1,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (3,'dbadm01','$2a$10$hIYQJlRx7A/OSGsPlVWy.u0Ft781TEN9I3je4nmJp6e0ZZ.QzSOFy','DB','Admin','dbadm@gmail.com',1,1,1,1,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (4,'tstsa01','$2a$10$Nq/OIjk7SdIQeuWnmZP0B.RYNLW4xSXbYst1wwtWl6qzksYfpucXK','Test','User','test@gmail.com',1,1,1,1,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (6,'tstsa02','$2a$10$WbQnaEXDpLdaVA1ijE02/uR2aqJukHHs9gQgIriLK9jHrXtYjU6kK','testuser','samuser','testuser2@gm.com',1,null,null,null,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (7,'tstsa03','$2a$10$C06DMC12z8yin5qyQb2KdOPyPB54fu4tdTemWSuid0XXKYnjZ.XxG','tstsa03','tstsa03','tstsa03@gm.com',null,null,null,null,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (8,'tstsa04','$2a$10$CPyQZXRttX7wMY80PQL8musnKBzXVmmaWbEhzHhCoceSeWFxyQctS','Aj04','Sam04','tstsa04@gmail.com',null,null,null,null,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (10,'sdf','$2a$10$liqIjrb3ZNVMAKP2WNmvNeqivRgng.y75TNrXbygbOm6narBYjSBq','yest','sdfds','ajaykumar99009@gmail.com',1,1,1,1,null,null,null);
Insert into BCTS_APP_USER (TRANSACTION_ID,SSO_ID,PASSWORD,FIRST_NAME,LAST_NAME,EMAIL,ACCT_LOCKED,USER_ENABLED,ACCT_EXPIRED,CREDENTIAL_EXPIRED,CREATED_DATE,PWD_UPDATED,PWD_EXPIRED_DATE) values (11,'test11','$2a$10$32dCQx5v6bmTyL1H4t7Eq.2rRwb7OluSY1Lu337XbJcqbrhDdbZrq','test11','test11','test11@mail.com',1,1,1,1,to_date('07/11/18','DD/MM/RR'),null,null);
...
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (7,3);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (7,4);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (8,3);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (8,4);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (9,1);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (10,3);
Insert into APP_USER_USER_PROFILE (USER_ID,USER_PROFILE_ID) values (11,1);
