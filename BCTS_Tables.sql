...
--Added By Ajay for Job control START---
CREATE TABLE BCTS_BATCH_ENDPOINT (	
   "ID" NUMBER(16,0), 
	"ENDPOINT_ID" NUMBER(16,0), 
	"ENDPOINT_NAME" VARCHAR2(50 BYTE), 
	"ENDPOINT_PROTOCOL" VARCHAR2(50 BYTE), 
	"ENDPOINT_URI" VARCHAR2(500 BYTE), 
	"ENDPOINT_IN_LOCATION" VARCHAR2(500 BYTE) DEFAULT NULL, 
	"ENDPOINT_OUT_LOCATION" VARCHAR2(500 BYTE) DEFAULT NULL, 
	"ENDPOINT_ERR_LOCATION" VARCHAR2(500 BYTE) DEFAULT NULL, 
	"ENDPOINT_PROC_LOCATION" VARCHAR2(500 BYTE) DEFAULT NULL, 
	"ENDPOINT_CRED_TYPE" CHAR(10 BYTE) DEFAULT 'CERT', 
	"ENDPOINT_CRED" VARCHAR2(50 BYTE), 
	"ENDPOINT_CRED_PWD" VARCHAR2(2000 BYTE) DEFAULT NULL, 
	"ORG_ID" NUMBER(16,0), 
	...
	"ENDPOINT_TYPE" CHAR(4 BYTE), 
	"UPDATED_BY" NUMBER(19,0), 
	"UPDATED_DATE" TIMESTAMP (6), 
	"ENDPOINT_PRIVATE_KEY" CLOB, 
	"ENDPOINT_PUBLIC_KEY" CLOB, 
	 PRIMARY KEY ("ENDPOINT_ID")
	 );

CREATE TABLE "BCTS_BATCH_ROUTE" (	
   "ID" NUMBER(16,0), 
	"ROUTE_ID" NUMBER(16,0), 
	"ROUTE_NAME" VARCHAR2(50 BYTE), 
	"ORG_ID" NUMBER(16,0), 
	"SRC_ENDPOINT_ID" NUMBER(16,0), 
	"DST_ENDPOINT_ID" NUMBER(16,0), 
	"RCP_ORG_ID" NUMBER(16,0) DEFAULT NULL, 
	"MAP_ID" NUMBER(16,0) DEFAULT NULL, 
	"RULE_ID" NUMBER(16,0) DEFAULT NULL, 
	"CTY_CODE" CHAR(2 BYTE) DEFAULT 'NC', 
	"CREATED_BY" VARCHAR2(255 BYTE), 
	"CREATED_DATE" TIMESTAMP (6), 
	"MODIFIED_BY" VARCHAR2(255 BYTE), 
	"MODIFIED_DATE" TIMESTAMP (6), 
...
CREATE TABLE "BCTS_BATCH_ROUTE_MAP" (
    "ID" NUMBER(16,0), 
	"MAP_ID" NUMBER(16,0) NOT NULL ENABLE, 
	"MAP_POST_PROC_CLS" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"MAP_BATCH_PROC_CLS" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"MAP_MAPPING_CLS" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"MAP_PROPERTIES_JSON" VARCHAR2(1024 BYTE) DEFAULT NULL, 
	"IN_FILENAME_PATTERN" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"RESP_FILENAME_PATTERN" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"OUT_FILENAME_PATTERN" VARCHAR2(200 BYTE) DEFAULT NULL, 
	"RUN_INTERVAL" NUMBER(5,0) NOT NULL ENABLE, 
	"LAST_RUN_STATUS" CHAR(1 BYTE) DEFAULT NULL, 
	"NEXT_TRIG" TIMESTAMP (0) DEFAULT NULL, 
