...
(
  ...
  CONSTRAINT BCTS_ALERT_PK
	PRIMARY KEY (CASE_ID)
	ENABLE VALIDATE,
  CONSTRAINT BCTS_ALERT_LICENCE_VALIDITY_FK 
  FOREIGN KEY (LICENCE_NO) 
  REFERENCES BCTS_LICENCE_VALIDITY (LICENCE_NO)
  ON DELETE CASCADE
  ENABLE VALIDATE,
  CONSTRAINT BCTS_ALERT_CASE_DEAIL_FK 
  FOREIGN KEY (CASE_DEAIL_ID) 
  REFERENCES BCTS_CASE_DEAIL (CASE_DEAIL_ID)
  ON DELETE CASCADE
  ENABLE VALIDATE
);
Commit;
