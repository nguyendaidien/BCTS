...
//			emails.push("abc@gmail.com");
//			emails.push("abc2@gmail.com");
//			$(this).val(JSON.stringify(emails));
			var existingEmails = alertEmails;
			if(existingEmails && existingEmails.length > 0) {
				$(this).val(JSON.stringify(existingEmails));
			}
...
//				$orig.val(emailString).trigger('change');
